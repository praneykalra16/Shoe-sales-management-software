...
conn= sql.connect(host='localhost', user = 'root', password ='12345678',database ='sms')
c1=conn.cursor()
chpasswd='d'
print('''+--------------------------+
/////////////////////////                                      
/////////////////////////
 WELCOME DEX SHOE STORE
    Amritsar(Punjab)
////////////////////////
///////////////////////
+--------------------------+''')
                ...
                if loggin==1:
                                while 3>1:
                                             ...
                                             #    elif appr =='n' or appr =='N':
                                                                                opn = input(" Generate bill (Y/N) : ")
                                                                                if opn == 'n' or opn == 'N':
                                                                                                         continue
                                                                                elif opn == 'y' or opn =='Y':
                                                                                                    just=input('MODE OF PAYMENT (Cash/Card):')
                                                                                                    print('                BILL')
                                                                                                    print('''            DEX SHOE STORE
                    ...
                    *******PLEASE VIST AGAIN*******''')
                                                ...
                                                print("4. SHOE Vs SALES")
                                                print("5. SHOE Vs STOCKS")
